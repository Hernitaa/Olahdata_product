        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- body -->
                    <form action="{{ url('updateMHS', $mahasw->id)}}" method="post">
                        {{ csrf_field() }}
                        <!-- hidden id -->
                        <input type="hidden" class="form-control" id="id" name="id" value="{{$mahasw->id}}"
                                aria-describedby="emailHelp">
                        <!-- end hidden id -->
                        <!-- form text field -->
                        <div class="mb-3">
                            <label for="exampleInputText" class="form-label">Nama Peserta</label>
                            <input type="text" class="form-control" id="nama" name="nama" value="{{$mahasw->nama}}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nbi" name="nbi" value="{{$mahasw->nbi}}"
                                aria-describedby="emailHelp" required autocomplete="off">
                            <div id="emailHelp" class="form-text">Ex: 14621000023</div>
                        </div>
                        <!-- end form text field -->
                        
                        <input type="submit" id="submit" class="btn btn-primary" onclick="edit()">
