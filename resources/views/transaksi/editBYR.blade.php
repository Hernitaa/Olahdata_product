...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    ...
    <title>Transaksi | Tambah Data</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form action="{{ url('updateBYR', $bayar->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <!-- body -->
                            ...
                            <div class="mb-3">
                                ...
                                <div id="emailHelp" class="form-text">Silahkan pilih produk yang ada</div>
                            </div>
                            <!-- end form text field -->
                            <!-- form text field -->
                            <div class="mb-3">
                                <label for="exampleInputText" class="form-label">Quantity (buah)</label>
                                <input type="text" class="form-control" id="quantity" name="quantity"
                                    aria-describedby="emailHelp" required autocomplete="off" value="{{$bayar->quantity}}">
                                <div id="emailHelp" class="form-text">Ex: 1</div>
                            </div>
                            <!-- end form text field -->
                            <input type="submit" id="submit" class="btn btn-primary" onclick="add()">
                            <a href="/pembayaran" class="btn btn-warning" onclick="back()">Kembali</a>
                        <!-- end body -->
                    </form>
